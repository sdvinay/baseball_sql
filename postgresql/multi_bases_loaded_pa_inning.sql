...
with gs_then_bl_in_inning as ( -- this query finds the instances
	    select mbp.*
	      from t_multiple_basesloaded_pas as mbp
	inner join retrosheet_event as e
	        on mbp.game_id = e.game_id and mbp.first_event = e.event_id
	     where e.event_cd=23 -- event code 23 is a HR
)
